...
export class AccordionComponent {
  ...
  accordion = [
    ...
    {
      withoutspaceAccordion: [{ hedingClass: 'accordion-no-gutter accordion-header-bg border-none' }]
    },
    {
    ...
    {
      headerBgAccordion: [{ hedingClass: 'accordion-header-bg accordion-bordered multi-bg', bg:true }]
    },
    {
