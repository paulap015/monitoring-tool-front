...
@Component({
  selector: 'app-profile-overview-head',
  standalone: true,
  imports: [
    RouterLink,
    BarChartApexComponent
  ],
  templateUrl: './profile-overview-head.component.html',
  styleUrl: './profile-overview-head.component.css'
})
export class ProfileOverviewHeadComponent {
